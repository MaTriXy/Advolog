...
2. **קבלת קליטה:** ⟪ממתין לנוסח המדויק של הילה — לא הגיע עם ההכרעה; התבנית המחייבת בינתיים: אישור קונקרטי (מה נשמר והיכן) + רשות מפורשת לעצור + דלת מותנית־נכונות (פירוט מה־יעזור נאמר רק אחרי "כן")⟫
3. **הכלה במצוקה (המשאב שזור, פעם אחת לישיבה):** ⟪ממתין לנוסח המדויק של הילה — לא הגיע עם ההכרעה; הצורה המחייבת: חום משני צידי המשאב, ער"ן 1201 / סה"ר בנשימה אחת, שורת ההכלה נשמרת לצד המשאב ולא במקומו⟫
...
- «זו לא רגישות יתר וזה לא בראש שלך — זו תבנית שמצדיקה בדיקה מחודשת, שחור על גבי לבן.»
