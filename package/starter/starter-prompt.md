...
<!-- One self-contained prompt. The user copies the block below into any capable AI chat — nothing to download, nothing to install. It carries the essential rules and the three file-less flows (welcome/interview, capture, express prep), and bootstraps a saveable record seed. The full package is the upgrade path, mentioned once, softly, only at a natural moment. [UF]: the shipped version of this block is Hebrew-first; this is the English master. -->
